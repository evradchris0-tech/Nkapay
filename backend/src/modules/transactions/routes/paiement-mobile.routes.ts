...
router.get('/transaction/:transactionId', (req, res, next) => paiementMobileController.findByTransaction(req, res, next));
router.get('/:id', (req, res, next) => paiementMobileController.findById(req, res, next));
router.post('/:id/envoyer', (req, res, next) => paiementMobileController.marquerEnvoye(req, res, next));
router.post('/:id/confirmer', (req, res, next) => paiementMobileController.confirmer(req, res, next));
router.post('/:id/echouer', (req, res, next) => paiementMobileController.marquerEchoue(req, res, next));
