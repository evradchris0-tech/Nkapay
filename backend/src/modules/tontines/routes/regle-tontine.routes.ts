...
router.get('/tontine/:tontineId', (req, res, next) =>
  regleTontineController.findByTontine(req, res, next)
);
router.get('/tontine/:tontineId/effectives', (req, res, next) =>
  regleTontineController.getEffectiveRules(req, res, next)
);
router.get('/tontine/:tontineId/valeur/:cle', (req, res, next) =>
  regleTontineController.getValueByCle(req, res, next)
);
router.post('/tontine/:tontineId/initialize', (req, res, next) =>
  regleTontineController.initializeDefaultRules(req, res, next)
);
