...
router.get('/exercice/:exerciceId', (req, res, next) =>
  regleExerciceController.findByExercice(req, res, next)
);
router.get('/exercice/:exerciceId/effectives', (req, res, next) =>
  regleExerciceController.getEffectiveRules(req, res, next)
);
router.get('/exercice/:exerciceId/valeur/:cle', (req, res, next) =>
  regleExerciceController.getEffectiveValueByCle(req, res, next)
);
router.post('/exercice/:exerciceId/initialize', (req, res, next) =>
  regleExerciceController.initializeFromTontine(req, res, next)
);
