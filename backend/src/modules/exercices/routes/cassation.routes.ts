...
router.post('/exercice/:exerciceId/calculer', (req, res, next) =>
  cassationController.calculer(req, res, next)
);
...
router.patch('/exercice/:exerciceId/distribuer-tout', (req, res, next) =>
  cassationController.distribuerTout(req, res, next)
);
...
router.get('/exercice/:exerciceId', (req, res, next) =>
  cassationController.findByExercice(req, res, next)
);

// Résumé des cassations d'un exercice
router.get('/exercice/:exerciceId/summary', (req, res, next) =>
  cassationController.getSummary(req, res, next)
);
...
router.delete('/exercice/:exerciceId/reset', (req, res, next) =>
  cassationController.resetExercice(req, res, next)
);
