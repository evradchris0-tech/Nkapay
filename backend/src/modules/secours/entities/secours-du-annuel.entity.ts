/**
 * Entite SecoursDuAnnuel
 * Cotisation annuelle au fonds de secours par membre
 */
...
@Entity('secours_du_annuel')
@Unique(['exerciceMembreId'])
export class SecoursDuAnnuel {
  ...
  @ManyToOne(() => ExerciceMembre, (em) => em.secoursDu, { onDelete: 'CASCADE' })
