...
export const idParamValidator = [
    param('id')
        .isUUID()
        .withMessage('Format d\'identifiant invalide (UUID attendu)'),
];

export const pieceIdParamValidator = [
    param('id')
        .isUUID()
        .withMessage('Format d\'identifiant événement invalide'),
    param('pieceId')
        .isUUID()
        .withMessage('Format d\'identifiant pièce invalide'),
];

export const exerciceIdParamValidator = [
    param('exerciceId')
        .isUUID()
        .withMessage('Format d\'identifiant exercice invalide'),
];
...
export const createEvenementSecoursValidator = [
    ...
    body('reunionId')
        .optional()
        .isUUID()
        .withMessage('Format reunionId invalide'),
];
...
export const ajouterPieceValidator = [
    ...
    body('typePiece')
        ...
        .isIn(['CERTIFICAT_MARIAGE', 'ACTE_DECES', 'CERTIFICAT_NAISSANCE', 'CERTIFICAT_MEDICAL', 'FACTURE', 'PHOTO', 'AUTRE'])
    ...
    body('cheminFichier')
        .notEmpty()
        .withMessage('Le chemin du fichier est requis'),
...
export const filterEvenementSecoursValidator = [
    query('exerciceId')
        .optional()
        .isUUID()
        .withMessage('Format exerciceId invalide'),

    query('exerciceMembreId')
        .optional()
        .isUUID()
        .withMessage('Format exerciceMembreId invalide'),
