...
export class UpdateSecoursSchema1708226000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKey("piece_justificative_secours", new TableForeignKey({
        ...
        await queryRunner.createForeignKey("evenement_secours", new TableForeignKey({
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        if (evenementTable) {
            const reunionFk = evenementTable.foreignKeys.find(fk => fk.columnNames.indexOf("reunion_id") !== -1);
