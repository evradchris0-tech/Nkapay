...
@Component({
  ...
  template: `
    <a routerLink="/dashboard/transactions" class="back-link"><span class="material-icons">arrow_back</span> Retour</a>
    <div class="placeholder"><h2>Nouvelle Transaction</h2><p>En cours de développement</p></div>
  `,
