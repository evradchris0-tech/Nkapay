...
@Component({
  ...
  template: `<a routerLink="/dashboard/penalites" class="back-link"><span class="material-icons">arrow_back</span> Retour</a><div class="placeholder"><h2>Nouvelle Pénalité</h2><p>En cours de développement</p></div>`,
...
export class PenaliteFormComponent {}
