...
@Component({
  ...
  template: `
    ...
    <div class="placeholder">
      ...
      <p>Liste des exercices en cours de développement</p>
    </div>
  `,
  styles: `
    ...
    .placeholder { display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 4rem; background: white; border-radius: 12px; color: #6b7280; }
