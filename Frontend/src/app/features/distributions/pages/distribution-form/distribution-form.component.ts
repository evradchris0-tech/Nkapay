...
@Component({
  ...
  template: `<a routerLink="/dashboard/distributions" class="back-link"><span class="material-icons">arrow_back</span> Retour</a><div class="placeholder"><h2>Nouvelle Distribution</h2><p>En cours de développement</p></div>`,
