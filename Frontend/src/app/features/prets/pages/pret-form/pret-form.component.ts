...
@Component({
  ...
  template: `<a routerLink="/dashboard/prets" class="back-link"><span class="material-icons">arrow_back</span> Retour</a><div class="placeholder"><h2>Nouveau Prêt</h2><p>En cours de développement</p></div>`,
